package JavaCore.block3.task348;
...
public class Task348 {
    ...
    public static void main(String[] args) {
        ComplexNumber n1 = new ComplexNumber(193.1123, 321.322);
        ComplexNumber n2 = new ComplexNumber(193.1123, 321.322);
        //System.out.println(Double.doubleToLongBits(n1.im));
        //System.out.println(Double.doubleToLongBits(n2.im));
    ...
    public static class ComplexNumber {
        ...
        @Override
        public int hashCode() {
            return (int) (im * 25 + this.re * 38);
            //return (int) (Double.doubleToLongBits(im) + Double.doubleToLongBits(re));
        }
        ...
        public boolean equals(Object object) {
            ...
            if (Double.compare(number.im, im) != 0) {
                return false;
            } else {

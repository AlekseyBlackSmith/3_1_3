package JavaCore.block2.task2310;
...
public class Task2310 {
    ...
    public static boolean isPalindrome(String text) {
        String original = text.toLowerCase().replaceAll("[^a-zA-Z0-9]", "");
        String revers = new StringBuffer(original).reverse().toString();
        return original.matches(revers);
    }
}
